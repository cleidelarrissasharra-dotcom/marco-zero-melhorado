...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#fdfbf7] text-stone-800 font-sans selection:bg-[#d95d39]/10 selection:text-[#d95d39]">
      ...
      {/* Main Container */}
      <main className="max-w-4xl mx-auto px-4 py-8 space-y-12 pb-20">
        
        {/* Cultural Welcome Hero Badge */}
        <section className="text-center space-y-4 max-w-2xl mx-auto">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-amber-50 border border-amber-100 text-[10px] font-mono text-[#d95d39] font-bold uppercase tracking-wider">
        ...
        <section className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="p-5 rounded-2xl bg-[#1e3d59]/5 border border-[#1e3d59]/10 space-y-2 flex gap-4 items-start">
          ...
          <div className="p-5 rounded-2xl bg-amber-500/5 border border-amber-500/10 space-y-2 flex gap-4 items-start">
      ...
      {/* Cultural Footer */}
      <footer className="border-t border-[#ebdccd] bg-[#fbf9f4] py-8 text-center text-xs text-stone-500 font-sans space-y-2">
